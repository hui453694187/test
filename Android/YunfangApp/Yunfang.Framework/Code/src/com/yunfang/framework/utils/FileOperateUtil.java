...
public class FileOperateUtil {
	...
	public final static int TYPE_CUSTOM = -1;// 视频
	 ...
	 * @return
	 */
	public static String createFileNameUUID(String extension) {
	 ...
	 * @return
	 */
	public static String createFileNameDate(String extension) {
