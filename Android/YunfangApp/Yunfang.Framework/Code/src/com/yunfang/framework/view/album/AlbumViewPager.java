package com.yunfang.framework.view.album;

import java.util.List;

import com.yunfang.framework.R;
import com.yunfang.framework.imageloader.DisplayImageOptions;
import com.yunfang.framework.imageloader.ImageLoader;
import com.yunfang.framework.imageloader.displayer.MatrixBitmapDisplayer;
import com.yunfang.framework.utils.FileOperateUtil;
import com.yunfang.framework.view.album.MatrixImageView.OnMovingListener;
import com.yunfang.framework.view.album.MatrixImageView.OnSingleTapListener;
...
public class AlbumViewPager extends ViewPager implements OnMovingListener {
	...
	public AlbumViewPager(Context context, AttributeSet attrs) {
		...
		builder =builder
				.showImageOnLoading(R.drawable.camera_stub)
				.showImageOnFail(R.drawable.camera_error)
				.cacheInMemory(true)
				.cacheOnDisk(false)
