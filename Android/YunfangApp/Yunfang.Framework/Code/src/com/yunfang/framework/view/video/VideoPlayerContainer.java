...
import com.yunfang.framework.view.video.VideoPlayerView.PlayerListener;
 ...
 * 
 */
public class VideoPlayerContainer extends LinearLayout implements OnClickListener, PlayerListener, VideoPlayerOperation {
	public final static String TAG = "VideoPlayerContainer";
	...
	public void resumePlay() {
		...
		mPauseButton.setImageResource(R.drawable.camera_video_detail_player_pause);
	}
	...
	public void pausedPlay() {
		...
		mPauseButton.setImageResource(R.drawable.camera_video_detail_player_start);
	}
